...
class ChatContainer extends StatelessWidget {
  const ChatContainer({super.key, required this.message, required this.chatId, required this.refreshParent});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            Icon(Icons.chat_bubble_outline_rounded, color: textcolortheme),
            ...
            IconButton(
              ...
              icon: Icon(Icons.delete_outline, color: textcolortheme),
            )
          ],
        ),
      ),
